...
export default function AboutUs() {
  return (
    <Section id="about-us" className="!pb-64">
      <Container className="grid gap-4 !pt-32 ">
        <h1 className="text-3xl lg:text-4xl font-semibold">About Us – P vs NP Solutions</h1>
        <p>
          At <b>P vs NP Solutions</b>, we’re the digital world’s answer to the problems most people don’t even know they have—until it’s too late. We specialize in <b>data retrieval</b>, <b>social-engineered penetration</b>, and <b>digital private eye services</b>, which is just a fancy way of saying we find what’s lost, uncover what’s hidden, and solve the puzzles others can’t (or won’t).
        </p>
        <p>
      ...
      <Container className="grid gap-4">
        ...
        <p>Because we’re not your average buttoned-up cybersecurity firm. We’re a team of problem solvers who thrive on challenges that make others sweat. The name <b>P vs NP</b> isn’t just a nerdy nod to computational theory—it’s our mindset. Some problems <b>should</b> be easy but aren’t. Others seem impossible until the right people dig in. That’s where we come in.</p>
      ...
      <Container className="grid gap-4">
        ...
        <p>(And yes, we <b>DO</b> like a good challenge. Try us.)</p>
      </Container>
    </Section>
  )
}
